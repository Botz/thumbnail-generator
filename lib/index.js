...
module.exports = function (_Plugin) {
  ...
  ThumbnailGenerator.prototype.getProportionalDimensions = function getProportionalDimensions(img, width, height, rotation) {
  ...
  ThumbnailGenerator.prototype.getOrientation = function getOrientation(file) {
    return new Promise(function (resolve, reject) {
      var reader = new FileReader();
      reader.onload = function (ev) {
        try {
          var tags = ExifReader.load(ev.target.result);
          var value = tags['Orientation'] ? tags['Orientation'].value : 1;
  ...
  ThumbnailGenerator.prototype.rotateImage = function rotateImage(image, translate) {
    var w = image.width;
    var h = image.height;
